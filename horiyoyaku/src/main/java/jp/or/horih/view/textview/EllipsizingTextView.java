...
package jp.or.horih.view.textview;
...
public class EllipsizingTextView extends TextView {
    ...
    private void resetText() {
        ...
        if (layout.getLineCount() > linesCount) {
            ...
            */
            ...
            int lineEndIndex = layout.getLineEnd(linesCount - 1);
            int reservingPosition = lineEndIndex - 1;

            try {
                if (isTooShortToReplace(workingText, lineEndIndex)) {
                    reservingPosition -= 1;
                }
                workingText = fullText.substring(0, reservingPosition).trim();
    ...
    private boolean isTooShortToReplace(CharSequence charSequence, int lineEndIndex) {
        ...
        if (ELLIPSIS.equals(str)) return true;
